...
public abstract class FilePathCustom {
    private static final String FOLDER_PATH = "computerLab/";
    private static final String GIYEGWAN = "giyegwan/";
    private static final String DEOGSEONG = "deogseong/";
    private static final String DIJAIN = "dijain/";
    ...
    static final String A50209 = FOLDER_PATH + DEOGSEONG + "50209.txt";
